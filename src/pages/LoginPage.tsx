      ...
      <div className="w-full max-w-md">
        <Card className="p-6">
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-3 text-lg font-semibold text-slate-900">MedSync AI Demo Login</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-sm">
            <label className="block text-xs font-medium text-slate-700 mb-1">Select a demo user</label>
            <select
