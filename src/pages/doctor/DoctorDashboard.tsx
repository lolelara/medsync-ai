            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-slate-500">
                {language === 'ar'
                  ...
                  : 'Not for real medical use  illustration of an assistant only.'}
              </span>
            </div>
            <textarea
              value={aiSymptoms}
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-slate-500">
              {language === 'ar'
                ? 'هذه معاينة تجريبية فقط، وليست وصفة طبية حقيقية.'
                : 'Demo-only preview, not a real prescription or medical advice.'}
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-md shadow-sm p-4 text-xs max-w-xl">
          <div className="flex items-start justify-between mb-2">
            <div>
              <div className="font-semibold text-slate-900">
                {language === 'ar' ? 'عيادة MedSync (عرض تجريبي)' : 'MedSync Clinic (demo)'}
              </div>
          ...
          <div className="border-t border-slate-200 pt-2 mt-2 space-y-1">
            ...
            <div className="text-[11px] text-slate-700">
              ...
              {draftDiagnosis || (language === 'ar' ? 'لم يُكتب تشخيص بعد' : 'No diagnosis entered yet')}
            </div>
          </div>
          ...
          <div className="border-t border-slate-200 pt-2 mt-2">
            ...
            {nonEmptyDraftMeds.length === 0 ? (
              <div className="text-[11px] text-slate-500">
                {language === 'ar' ? 'لم تتم إضافة أدوية بعد.' : 'No medications have been added yet.'}
              </div>
            ) : (
          ...
          {followUpDays > 0 && (
            <div className="border-t border-slate-200 pt-2 mt-2 text-[11px] text-slate-700">
              {language === 'ar'
          ...
          <div className="border-t border-slate-200 pt-2 mt-2 text-[10px] text-slate-400">
            {language === 'ar'
              ? 'هذا المستند جزء من عرض تجريبي لمنصّة MedSync AI ولا يُستخدم كوصفة طبية حقيقية.'
